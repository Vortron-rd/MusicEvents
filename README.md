...
- **Roguelike Dungeons Support!** The mod will automatically save the locations of Roguelike Dungeons and can play custom music when the player is in range of a Roguelike Dungeon!
...
<details>
  <summary>Setting up the music config</summary>
